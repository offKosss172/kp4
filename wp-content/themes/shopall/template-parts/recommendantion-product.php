...
foreach ( $products as $product ) {
    ...
    <div class="product type-product has-post-thumbnail shipping-taxable purchasable product-type-simple">
        ...
        class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" decoding="async" loading="lazy"><h4 class="woocommerce-loop-product__title"><?php echo $prod_one->get_name() ?></h4> 
            <span class="price">
                <span class="woocommerce-Price-amount amount">
                    <bdi>
                        <!-- <span class="woocommerce-Price-currencySymbol">€</span> -->
                        <?php echo $prod_one->get_price_html() ?>
                    </bdi>
                </span>
            </span>
        </a>
