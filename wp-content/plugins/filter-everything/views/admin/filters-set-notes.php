...
<table class="wpc-notes-table">
    <?php
    printf( '<tr><th>_price</th><td>%s</td></tr>', esc_html__( 'filter by Product price (Custom Field Numeric)', 'filter-everything' ) );
    printf( '<tr><th>_stock_status</th><td>%s</td></tr>', esc_html__( 'filter by Product Stock status (Custom Field)', 'filter-everything' ) );
    printf( '<tr><th>_sale_price</th><td>%s</td></tr>', esc_html__( 'by Sale Price (Custom Field Numeric) or on Sale Status (Custom Field Exists)', 'filter-everything' ) );
    ...
    printf( '<tr><th>_stock</th><td>%s</td></tr>', esc_html__( 'by Stock Quantity (Custom Field Numeric)', 'filter-everything' ) );
