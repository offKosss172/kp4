    ...
    private function setupDefaultFields()
    {
        ...
        $defaultFields = array(
            ...
            'label' => array(
                ...
                'instructions'  => esc_html__(  'Will appear in Filters widget', 'filter-everything' )
            ),
            'slug' => array(
                'type'          => 'Text',
            ...
            'orderby' => array(
                ...
                'tooltip'       => wp_kses(
                    __( '"Default" option means that terms will be sorted in the order as they were received from DataBase<br />The "Menu order" option is available for WooCommerce attributes only.', 'filter-everything' ),
                    array( 'br' => array() )
                )
            ),
            'in_path' => array(
            ...
            'collapse' => array(
                ...
                'default'       => 'no',
                'instructions'  =>  esc_html__( 'Makes filter collapsible in widget', 'filter-everything'),
                'tooltip'       => esc_html__( 'Useful in situation when the filter is rarely applied but takes up some space in widget. Collapsed by default.', 'filter-everything' )
            ),
            'hierarchy' => array(
                'type'          => 'Checkbox',
            ...
            'parent_filter' => array(
                ...
                'instructions'  => esc_html__( 'If specified, current Filter terms become available only after parent Filter selected', 'filter-everything' )
            ),
            'hide_until_parent' => array(
                'type'          => 'Checkbox',
                'label'         => esc_html__( 'Hide until Parent selected', 'filter-everything' ),
                'class'         => 'wpc-field-hide-until-parent',
                'default'       => 'no',
                'instructions'  => esc_html__( 'Do not show this Filter until a parent selected. Useful for step by step filtering', 'filter-everything' )
            ),
            'tooltip' => array(
                'type'          => 'Text',
...
//            241 => esc_html__( 'Error: invalid Order field.', 'filter-everything' ),
            ...
            46 => esc_html__( 'Error: numeric filter can not be in URL path.', 'filter-everything' ),
            ...
            90 => wp_kses(
                sprintf(
                    __('Error: you can not update settings because Filter Everything Pro plugin is locked. Please, enter your <a href="%1$s" target="_blank">license key</a> to unlock it.', 'filter-everything' ),
            ...
            91 => esc_html__('Error: you can not update settings because Filter Everything Pro plugin is locked. Please, ask your site Superadmin enter plugin license key to unlock it.', 'filter-everything' ),
