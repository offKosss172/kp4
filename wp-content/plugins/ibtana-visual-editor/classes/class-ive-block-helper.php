		...
		public static function get_button_css( $attr, $id ) {
			...
			$selectors = array(
				' .anchrstyle' => array(
					...
					'text-transform'		=> isset($attr['ive_buttoncontentTransform']) ? $attr['ive_buttoncontentTransform'] : '',
				),
				...
				'.btn-inner-wrap' => array(
					...
					'margin-left'			=> isset($attr['btns'][$index]['deskMarginLeft']) ? $attr['btns'][$index]['deskMarginLeft'] . $unit : '20'.$unit,
				),
				...
				' .anchrstyle .ive-button-icon-padding'.$index => array(
					...
					'padding-bottom'			=> isset($attr['btns'][$index]['iconpaddingbottom']) ? $attr['btns'][$index]['iconpaddingbottom'].$unit: '5'.$unit,
					'color'					=> isset($attr['iconColor']) ? $attr['iconColor'] : '',
					'background-color'		=> isset($attr['iconBGColor']) ? $attr['iconBGColor'] : '',
					'margin-left'			=> isset($attr['btns'][$index]['marginleft']) ? $attr['btns'][$index]['marginleft'].$unit : ''.$unit,
					'margin-right'			=> isset($attr['btns'][$index]['marginright']) ? $attr['btns'][$index]['marginright'].$unit : ''.$unit,
			...
			$t_selectors = array(
				...
				'.btn-inner-wrap' => array(
					...
					'margin-left'			=> isset($attr['btns'][$index]['tabMarginLeft']) ? $attr['btns'][$index]['tabMarginLeft'] . $unit : '20'.$unit,
				),
				' .anchrstyle .ive-button-icon-padding'.$index.' i' => array(
            ...
            $m_selectors = array(
				...
				'.btn-inner-wrap' => array(
					...
					'margin-left'			=> isset($attr['btns'][$index]['mobMarginLeft']) ? $attr['btns'][$index]['mobMarginLeft'] . $unit : '20'.$unit,
				),
				' .anchrstyle .ive-button-icon-padding'.$index.' i' => array(
        ...
        ' .ive-post-slider-parent'.$uniqueID.' .post-content-area .ive_latest_post_comments' => array(
          'order' => $attr['commentOrderPosition']
				...
				' .ive-post-slider-parent'.$uniqueID.' .post-content-area .post-image:hover' => array(
					'color' => isset( $attr['imageColorTabHov'] ) ? $attr['imageColorTabHov'] : '',
	      ...
	      if ( $attr['iconAlignButton'] == 'left' ) {
			...
			if ( $post_type == 'post' ) {
				...
				$selectors[' .post-image img']		=	array(
					'margin-left'		=>	isset( $attr['imgleftmargin'] ) ? $attr['imgleftmargin'] . 'px !important' : 'auto !important',
					'margin-right'	=>	'auto'
				);
